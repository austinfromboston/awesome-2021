    ...
    >
      <Inner>
        <Intro
          ...
          event_date={data.event_date.text}
          location={data.location.text}
          updates={data.general_updates.html}
        ...
        <div className="useful-links">
          ...
          <br />
          {data.schedule_link && data.schedule_link.url && (
            <a href={data.schedule_link?.url}>The Evolving Schedule</a>
          )}
          <br />
          {data.meals_link && data.meals_link.url && <a href={data.meals_link?.url}>Meal Planning</a>}
          <br />
          {data.ride_board_link && data.ride_board_link.url && (
            <a href={data.ride_board_link?.url}>Coordinate a Ride</a>
          )}
          <br />
          {data.facebook_event_link && data.facebook_event_link.url && (
